...
public class S_BOX {
	...
	public final char sbox_encryption[] = { 0x63, 0x7c, 0x77, 0x7b, 0xf2, 0x6b, 0x6f, 0xc5, 0x30, 0x01, 0x67, 0x2b,
	...
	public final char sbox_decryption[] = { 0x52, 0x09, 0x6a, 0xd5, 0x30, 0x36, 0xa5, 0x38, 0xbf, 0x40, 0xa3, 0x9e,
	...
	public S_BOX(char mode) {
		this.mode = mode;
	}

	public char[] getSBOX() {
		if (this.mode == 'e') {
			return sbox_encryption;
		}
		return sbox_decryption;
	}
}
